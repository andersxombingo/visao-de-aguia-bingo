const CACHE='visao-de-aguia-v10-import-90';
const ASSETS=['./','./index.html','./styles.css','./app.js','./seed-data.js','./photo-mode.js','./manifest.json','./icon.svg','./icon-192.png','./icon-512.png'];
